...
export const findOneAndPopulate = async (modelName, criteria, projection = {}, options: any = {}, populateModel) => {
    options.lean = true;
...
export const updateMany = async (modelName, criteria, dataToSet, options: any = {}) => {
    return modelName.updateMany(criteria, dataToSet, options);
}

export const findAllWithPopulate = async (modelName, criteria, projection = {}, options: any = {}, populateModel) => {
    options.lean = true;
...
export const deleteOne = async (modelName, criteria, options: any = {}) => {
    return modelName.deleteOne(criteria, options);
}

export const deleteMany = async (modelName, criteria, options: any = {}) => {
    return modelName.deleteMany(criteria, options);
}