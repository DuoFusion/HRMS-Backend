...
router.post('/grant', VALIDATE_ROLE([ROLES.SUPER_ADMIN, ROLES.ADMIN, ROLES.HR]), userModuleAccessController.add_user_module_access);
router.put('/update', VALIDATE_ROLE([ROLES.SUPER_ADMIN, ROLES.ADMIN, ROLES.HR]), userModuleAccessController.edit_user_module_access);
